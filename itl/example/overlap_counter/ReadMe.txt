========================================================================
    KONSOLENANWENDUNG: overlap_counter-Projektübersicht
========================================================================

Diese overlap_counter-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre overlap_counter–Anwendung besteht.


overlap_counter.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "overlap_counter.pch" und eine 
