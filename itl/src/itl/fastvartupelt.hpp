...
#ifndef __FastVarTupelT_JOFA_040614_H__
#define __FastVarTupelT_JOFA_040614_H__
...
namespace itl
{
    ...
    */
    ...
    template <int varCountV>
    std::string FastVarTupelT<varCountV>::as_string()const
    {
...
#endif __FastVarTupelT_JOFA_040614_H__
