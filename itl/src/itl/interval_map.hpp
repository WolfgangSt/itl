...
<
    typename DomainT,
    typename CodomainT,
    class NeutronHandler = itl::neutron_absorber,
    template<class>class Interval = itl::interval,
    template<class>class Compare  = std::less,
    template<class>class Alloc    = std::allocator
>
class interval_map:
	public interval_base_map<interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>, 
                             DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>
{
public:
    typedef interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc> type;
    typedef type joint_type;
    typedef interval_base_map <interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>, 
                               DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc> base_type;
...
private:
	...
	{ 
		return !value.KEY_VALUE.empty() 
	        && !(NeutronHandler::absorbs_neutrons() && value.CONT_VALUE == CodomainT()); 
	}
...
template <typename DomainT, typename CodomainT, class NeutronHandler, template<class>class Interval, template<class>class Compare, template<class>class Alloc>
void interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>
...
template <typename DomainT, typename CodomainT, class NeutronHandler, template<class>class Interval, template<class>class Compare, template<class>class Alloc>
bool interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>
...
template <typename DomainT, typename CodomainT, class NeutronHandler, template<class>class Interval, template<class>class Compare, template<class>class Alloc>
void interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>::getResiduals(const interval_type& x_itv, interval_type& leftResid, interval_type& rightResid)
{
...
template <typename DomainT, typename CodomainT, class NeutronHandler,
...
template <typename DomainT, typename CodomainT, class NeutronHandler,
          template<class>class Interval, template<class>class Compare, template<class>class Alloc>
typename interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>::iterator 
    interval_map<DomainT,CodomainT,NeutronHandler,Interval,Compare,Alloc>
    ...
    ::fill_join_left(const value_type& value)
{
	...
	if(NeutronHandler::absorbs_neutrons() && value.CONT_VALUE == CodomainT())
		return this->_map.end();
    ...
    ::add(const value_type& x)
{
	...
	if(NeutronHandler::absorbs_neutrons() && x_val==CodomainT()) 
		return;

    std::pair<iterator,bool> insertion = this->_map.insert(x);
	...
	::add_rest(const interval_type& x_itv, const CodomainT& x_val, iterator& it, iterator& end_it)
{
    ...
    while(nxt_it!=end_it)
    {
		...
		fill_join_left(value_type(left_gap, x_val)); //A posteriori

		if(NeutronHandler::absorbs_neutrons() && it->CONT_VALUE == CodomainT())
			this->_map.erase(it++);
		else
		{
    ...
    ::subtract_rest(const interval_type& x_itv, const CodomainT& x_val, iterator& it, iterator& end_it)
{
    ...
    while(nxt_it!=end_it)
    {
		...
		if(NeutronHandler::absorbs_neutrons() && cur_val==CodomainT())
			this->_map.erase(it++); 
        else
		{
			join_left(it);
...
//-----------------------------------------------------------------------------
template <typename DomainT, typename CodomainT, class NeutronHandler, template<class>class Interval, 
...
<
	...
	class NeutronHandler, template<class>class Interval, 
	template<class>class Compare, template<class>class Alloc
>
interval_base_map<SubType,DomainT,CodomainT,
                  NeutronHandler,Interval,Compare,Alloc>& 
operator +=
(
     interval_base_map<SubType,DomainT,CodomainT,
	                   NeutronHandler,Interval,Compare,Alloc>& object,
	const interval_map<DomainT,CodomainT,
	                   NeutronHandler,Interval,Compare,Alloc>& operand
)
{
	typedef interval_base_map<SubType,DomainT,CodomainT,NeutronHandler,
...
)
{
    ...
    typedef typename interval_map<DomainT,CodomainT,
		NeutronHandler,Interval,Compare,Alloc>::base_type map_base;
...
template <class KeyT, class DataT, class Neutronizer>
struct type<itl::interval_map<KeyT,DataT,Neutronizer> >
{
