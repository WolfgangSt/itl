...
namespace itl
{
    ...
    */
	...
	//void interval_set_splitter<DomainT,Interval,Compare,Alloc>::insert(const value_type& x)
	//{
	//	if(x.empty()) return;
	...
	//template<class DomainT, template<class>class Interval, template<class>class Compare, template<class>class Alloc>
	//void interval_set_splitter<DomainT,Interval,Compare,Alloc>::subtract(const value_type& x)
	//{
	//	if(x.empty()) return;
	//	typename ImplSetT::iterator fst_it = _set.lower_bound(x);
